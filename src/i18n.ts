...
const resources = {
  en: {
    translation: {
      ...
      importXlsxHint: 'Drag & drop .xlsx files to import (folders not supported). Right-click for paste.',
      importImages: 'Import Images',
      importImagesHint: 'Drag & drop image folders to import (filenames must be ID.xxx). Right-click for paste.',
      ...
      rightClickForPaste: 'Right-click to paste',
  ...
  zh: {
    translation: {
      ...
      importXlsxHint: '拖拽 .xlsx 文件导入（不支持文件夹），右键可粘贴',
      importImages: '导入图片',
      importImagesHint: '仅支持拖拽图片文件夹导入（文件名需为 ID.xxx），右键可粘贴截图',
