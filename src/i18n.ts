...
const resources = {
  en: {
    translation: {
      ...
      importXlsxHint: 'Drag, drop, or paste .xlsx files to import',
      importImages: 'Import Images',
      importImagesHint: 'Drag folders or paste JPEG images to import (filenames: <id>.jpg)',
      importImagesSuccess: 'Imported images successfully, total {{count}} images',
      generatedFileName: 'Generated name: {{name}}',
      storage: 'Storage',
      usage: 'Usage',
      quota: 'Quota',
      notAvailable: 'N/A',
      ...
      dragDropOrChooseImage: 'Drag, choose, or paste an image',
      dragDropMultipleOrPickFolder: 'Drag or paste multiple images (A–E) or pick a folder',
      dragDropMultiple: 'Drag or paste multiple images',
      dragDropMultipleCustom: 'Drag or paste images to auto-fill slots',
  ...
  zh: {
    translation: {
      ...
      importXlsxHint: '拖拽或粘贴 .xlsx 文件导入',
      importImages: '导入图片',
      importImagesHint: '拖拽文件夹或粘贴 JPG 图片导入（文件名需为 ID.jpg）',
      importImagesSuccess: '读取成功，共{{count}}张图片',
      generatedFileName: '生成的文件名：{{name}}',
      storage: '存储',
      usage: '已用',
      quota: '配额',
      notAvailable: '不可用',
      ...
      dragDropOrChooseImage: '拖拽、选择或粘贴图片',
      dragDropMultipleOrPickFolder: '拖拽或粘贴多张图片（A–E）或选择文件夹',
      dragDropMultiple: '拖拽或粘贴多张图片',
      dragDropMultipleCustom: '拖拽或粘贴图片以自动填充槽位',
      viewLarge: '看大图',
      back: '返回',
