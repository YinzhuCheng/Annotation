...
const resources = {
  en: {
    translation: {
      ...
      latexFixAll: 'Fix question + options + answer',
      latexFixAllHint: 'Normalize every part of the problem at once so all MathJax expressions render cleanly.',
      ...
      options: 'Options',
      optionFixTitle: 'Per-question option correction',
      optionFixHint: 'Normalize cached choices into clean A–E options with undo and feedback.',
      optionFixConvert: 'Convert',
      optionFixBusy: 'Converting…',
      optionFixUndo: 'Undo',
      optionFixRawLabel: 'Original option cache',
      optionFixRawPlaceholder: 'Paste or edit the raw option text for this question…',
      optionFixRulesLabel: 'Heuristic preview',
      optionFixRulesEmpty: 'No heuristic candidates detected yet.',
      optionFixHistoryLabel: 'LLM conversation',
      optionFixNoHistory: 'No correction history for this question.',
      optionFixFeedbackLabel: 'Feedback to LLM',
      optionFixFeedbackPlaceholder: 'Describe what should change and click Send.',
      optionFixSendFeedback: 'Send feedback',
      optionFixRawMissing: 'Provide option source text before converting.',
      optionFixFeedbackDisabled: 'Run Convert first before sending feedback.',
      optionFixNoticeHeuristics: 'LLM output was invalid; applied heuristic fallback.',
      optionFixNoticeLatexSkipped: 'Skipped LaTeX normalization because the latex agent is not configured.',
      optionFixParseError: 'Unable to parse the LLM response.',
      optionFixRoleUser: 'User',
      optionFixRoleAssistant: 'Assistant',
      ...
      bulkRenameTitle: 'Batch rename IDs & images',
      bulkRenameHint: 'Rename every problem ID and duplicate images as time+index JPG files.',
      bulkRenameButton: 'Batch rename',
      bulkRenameWorking: 'Renaming...',
      bulkRenameConfirm: 'This will rename all problem IDs and images and overwrite files. Continue?',
      bulkRenameSuccess: 'Renamed {{count}} problems.',
      bulkRenameError: 'Batch rename failed. Please try again.',
      bulkRenameEmpty: 'No problems available for batch rename.',
      bulkAutoFixTitle: 'LLM batch format correction',
      bulkAutoFixHint: 'Normalize MathJax, options, and metadata for a selected ID range without altering problem intent.',
      bulkAutoFixStartId: 'Start ID',
      bulkAutoFixLimit: 'Question count',
      bulkAutoFixButton: 'Run correction',
      bulkAutoFixWorking: 'Processing…',
      bulkAutoFixProgress: 'Processing {{current}} / {{total}} (ID {{id}})',
      bulkAutoFixUnknownId: 'unknown',
      bulkAutoFixSummary: 'Finished: {{updated}} updated, {{processed}} total, {{failed}} failed.',
      bulkAutoFixErrorsLabel: 'Issues ({{count}})',
      bulkAutoFixErrorsMore: '+{{remaining}} more errors.',
      bulkAutoFixInvalidStart: 'Start ID "{{id}}" was not found.',
      bulkAutoFixInvalidCount: 'Enter a positive question count.',
      bulkAutoFixEmptyRange: 'No problems found for the selected range.',
      ...
      qaAssistantImagePlaceholder: '[Image attached]',
  ...
  zh: {
    translation: {
      ...
      latexFixAll: '一键校正题干/选项/答案',
      latexFixAllHint: '一次性修复题干、选项与答案中的数学表达式，保证 MathJax 渲染。',
      ...
      options: '选项',
      optionFixTitle: '逐题选项校正',
      optionFixHint: '针对缓存的原始选项做智能拆解，输出标准 A–E 结构，支持撤销与反馈。',
      optionFixConvert: '转换',
      optionFixBusy: '转换中…',
      optionFixUndo: '撤销',
      optionFixRawLabel: '原始选项缓存',
      optionFixRawPlaceholder: '在此粘贴或调整该题的原始选项文本…',
      optionFixRulesLabel: '启发式识别预览',
      optionFixRulesEmpty: '暂未识别出可用的候选选项。',
      optionFixHistoryLabel: 'LLM 对话',
      optionFixNoHistory: '当前题目还没有校正记录。',
      optionFixFeedbackLabel: '向 LLM 反馈',
      optionFixFeedbackPlaceholder: '描述需要调整的内容后点击发送。',
      optionFixSendFeedback: '发送反馈',
      optionFixRawMissing: '请先提供选项原始文本再进行转换。',
      optionFixFeedbackDisabled: '请先执行一次“转换”再发送反馈。',
      optionFixNoticeHeuristics: 'LLM 输出不符合要求，已回退到启发式处理。',
      optionFixNoticeLatexSkipped: '由于未配置 LaTeX 代理，已跳过 LaTeX 规范化。',
      optionFixParseError: '无法解析 LLM 返回的内容。',
      optionFixRoleUser: '用户',
      optionFixRoleAssistant: '助手',
      answer: '解答 / 证明过程',
      imageBlock: '图片',
      singleBlock: '单图块',
      ...
      exportImages: '导出图片',
      bulkRenameTitle: '批量重命名',
      bulkRenameHint: '按“时间+序号”重命名所有题目及其图片，并统一生成 JPG，重复引用会复制多份。',
      bulkRenameButton: '执行重命名',
      bulkRenameWorking: '重命名中...',
      bulkRenameConfirm: '将重命名所有题目 ID 与图片并覆盖旧文件，确定继续？',
      bulkRenameSuccess: '已重命名 {{count}} 道题。',
      bulkRenameError: '重命名失败，请稍后重试。',
      bulkRenameEmpty: '当前没有可重命名的题目。',
      bulkAutoFixTitle: 'LLM 批量格式校正',
      bulkAutoFixHint: '针对所选 ID 区间批量调用 LLM 规范 MathJax、选项与元数据，仅做格式修正不改动题意。',
      bulkAutoFixStartId: '起始 ID',
      bulkAutoFixLimit: '题量',
      bulkAutoFixButton: '执行校正',
      bulkAutoFixWorking: '校正中…',
      bulkAutoFixProgress: '第 {{current}} / {{total}} 条（ID {{id}}）',
      bulkAutoFixUnknownId: '未知',
      bulkAutoFixSummary: '完成：共处理 {{processed}} 条，{{updated}} 条更新，{{failed}} 条失败。',
      bulkAutoFixErrorsLabel: '失败列表（{{count}}）',
      bulkAutoFixErrorsMore: '另有 {{remaining}} 条错误。',
      bulkAutoFixInvalidStart: '未找到起始 ID "{{id}}"。',
      bulkAutoFixInvalidCount: '题量必须为正整数。',
      bulkAutoFixEmptyRange: '所选范围内没有题目。',
      importXlsx: '导入 XLSX',
      ...
      qaAssistantImagePlaceholder: '[已附图片]',
