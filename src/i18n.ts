...
const resources = {
  en: {
    translation: {
      ...
      importXlsxHint: 'Drag & drop .xlsx files to import',
      importImages: 'Import Images',
      importImagesHint: 'Drag & drop image folders to import (filenames: <id>.jpg)',
  ...
  zh: {
    translation: {
      ...
      importXlsxHint: '拖拽 .xlsx 文件导入',
      importImages: '导入图片',
      importImagesHint: '拖拽图片文件夹导入（文件名需为 ID.jpg）',
