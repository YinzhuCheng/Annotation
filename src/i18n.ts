...
const resources = {
  en: {
    translation: {
      ...
      previewOpen: 'Question preview',
      previewClose: 'Hide preview',
      questionPreviewTitle: 'Question Preview',
      questionPreviewHint: 'Read-only MathJax rendering of the current problem.',
  ...
  zh: {
    translation: {
      ...
      previewOpen: '题目预览',
      previewClose: '收起预览',
      questionPreviewTitle: '题目预览',
      questionPreviewHint: '只读 MathJax 渲染视图，用于检查题目信息。',
