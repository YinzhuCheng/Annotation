...
const resources = {
  en: {
    translation: {
      ...
      bulkAutoFixEndId: 'End ID',
      bulkAutoFixLimit: 'Batch size (optional)',
      ...
      bulkAutoFixInvalidEnd: 'End ID "{{id}}" was not found.',
  ...
  zh: {
    translation: {
      ...
      bulkAutoFixEndId: '结束 ID',
      bulkAutoFixLimit: '批次长度（可选）',
      ...
      bulkAutoFixInvalidEnd: '未找到结束 ID "{{id}}"。',
