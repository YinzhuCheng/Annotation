...
const resources = {
  en: {
    translation: {
      ...
      // File/image picking & hints
      browse: 'Browse',
      folder: 'Folder',
      dropHintSingle: 'Drag & drop or choose an image',
      dropHintOptions: 'Drag & drop multiple images (A–E) or pick a folder',
      dropHintPaste: 'Drag & drop or paste screenshot',
  ...
  zh: {
    translation: {
      ...
      browse: '选择文件',
      folder: '选择文件夹',
      dropHintSingle: '拖拽或选择一张图片',
      dropHintOptions: '拖拽多张图片（A–E）或选择文件夹',
      dropHintPaste: '拖拽或粘贴截图',
      viewLarge: '看大图',
      backToApp: '返回',
      exportXlsx: '导出 XLSX',
