...
const resources = {
  en: {
    translation: {
      ...
      llmAssistGenerateHint: 'Let the generator rephrase the current draft to match the selected problem type, add any missing definitions, and autofill structured fields. Review the output after each run.',
  ...
  zh: {
    translation: {
      ...
      llmAssist: 'LLM 辅助工具',
      llmAssistGenerateHint: '点击下方按钮，可引导大语言模型根据当前草稿重写题干以符合目标题型，完善结构化字段。生成完成后请检查结果。',
      yourMessage: '你的消息',
      send: '发送',
